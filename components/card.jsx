...
const CampaignCard = () => {
    ...
    return (
        <div class="col-md-4">
                    <div class="card mb-4 shadow overflow-hidden rounded">
                        ...
                        <div class="card-body">
                            <h3 class="card-text text-left">Title</h3>
                            ...
                            <div class="d-flex">
                                ...
                                </svg> <span class="mx-1"> 4 days </span>
                                </div>
                            </div>

                            <div class="progress my-3 rounded-pill">
                                <div class="progress-bar bg-success rounded-pill " role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <div class="d-flex flex-row justify-content-between align-items-center">

                                <div>
                                    <h5 class="my-0">$587</h5>
                                    <p class="gray">funded of $20K</p>
                                </div>
